...
import banerImage from "/images/baner-1.png"

const Banner = () => {
  return (
    <div className="banner bg-secondary my-5">
      <div className="container py-5">
        <div className="row g-4 align-items-center">
          <div className="col-lg-6">
            <div className="py-4">
              <h1 className="display-5 text-white">Fresh Exotic Fruits</h1>
          ...
          <div className="col-lg-6">
            <div className="position-relative">
              <img src={banerImage} className="img-fluid w-100 rounded" alt="Banner" />
              <div
